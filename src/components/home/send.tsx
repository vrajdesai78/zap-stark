...
export default function Send() {
  ...
  return (
    <>
      ...
      {thread === "TWO" && (
        <div className="flex flex-col w-full h-full gap-[9rem] items-center justify-between my-5">
      ...
      {thread === "THREE" && (
        <div className="flex flex-col w-full h-full gap-[4rem] items-center justify-between my-5">
          <div className="flex flex-col w-full items-center justify-center gap-6">
            ...
            <div className="flex flex-col w-full items-center justify-center gap-[2px] my-5">
